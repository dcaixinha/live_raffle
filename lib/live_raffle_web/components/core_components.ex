defmodule LiveRaffleWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LiveRaffleWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LiveRaffleWeb.Gettext, "errors", msg, opts)
    end
  end
